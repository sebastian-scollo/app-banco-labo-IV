    ...
    <div class="form-container">
        ...
        <div class="form-group-pair">
            <div class="form-group">
                <input type="text" id="montoPrestamo" placeholder="Ingrese el monto que desea" class="form-input"  >
            </div>
            <div class="form-group">
                <input type="text" id="tipoCuotas" placeholder="Ingrese la cantidad de cuotas que desea(3-6-12)" class="form-input" >
            </div>
        </div>
        
        <!-- Boton de envio -->
        <input type="submit" class="submit-btn" value="Solicitar Prestamo"> </input>
       </form> 
    </div>
</body>
</html>