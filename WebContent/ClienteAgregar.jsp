    ...
    <div class="form-container">
        ...
        <div class="form-group-pair">
            <div class="form-group">
                ...
                <input type="text" id="txtCuit" name="txtCuil" placeholder="CUIT" class="form-input">
            </div>
            <div class="form-group">
                <input type="text" id="numero-documento" name="txtDni" placeholder="Numero de documento" class="form-input">
            </div>
        </div>
